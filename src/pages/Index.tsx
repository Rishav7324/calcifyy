...
const Index = () => {
  ...
  const featuredCalculators = [
    { name: "BMI Calculator", path: "/calculator/bmi", uses: "2.4M+" },
    { name: "Loan Calculator", path: "/calculator/loan", uses: "1.8M+" },
    { name: "Currency Converter", path: "/calculator/currency", uses: "3.1M+" },
    { name: "Discount Calculator", path: "/calculator/discount", uses: "1.2M+" },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-4">
              {featuredCalculators.map((calc) => (
                <Link key={calc.name} to={calc.path}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {categories.map((category, index) => {
              ...
              return (
                ...
                >
                  <div className="glass-card p-8 rounded-2xl hover:shadow-glow transition-all duration-300 hover:-translate-y-2 h-full animate-scale-in">
